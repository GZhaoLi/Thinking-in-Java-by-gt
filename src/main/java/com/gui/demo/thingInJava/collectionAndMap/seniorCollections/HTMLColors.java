package com.gui.demo.thingInJava.collectionAndMap.seniorCollections;

import java.util.*;
import java.util.stream.Collectors;

/**
 * @Classname HTMLColors
 * @Description TODO
...
public class HTMLColors {
    ...
    public static final Map<Integer, String> MAP =
            Arrays.stream(ARRAY)
                    .collect(Collectors.toMap(element -> (Integer) element[0],
    ...
    public static final Map<String, Integer> INTEGER_MAP = invert(MAP);

    //根据colorName匹配编码
    public static Integer rgb(String colorName) {
        return INTEGER_MAP.get(colorName);
    }
    ...
    public static void show(Map.Entry<Integer, String> entry) {
        System.out.format("0x%06X: %s%n", entry.getKey(), entry.getValue());
    }
