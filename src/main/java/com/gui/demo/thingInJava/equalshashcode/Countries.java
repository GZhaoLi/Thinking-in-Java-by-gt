...
public class Countries {
    ...
    private static class FlyweightMap extends AbstractMap<String, String> {
        ...
        private static class Entry implements Map.Entry<String, String> {
            ...
            public boolean equals(Object o) {
                ...
                return Objects.equals(DATA[index][0], o);
            }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getNames(10));
        ...
        System.out.println(new HashSet<>(getNames(6)));
        System.out.println(new LinkedHashSet<>(getNames(6)));
        System.out.println(new TreeSet<>(getNames(6)));
        System.out.println(new ArrayList<>(getNames(6)));
        System.out.println(new LinkedList<>(getNames(6)));
